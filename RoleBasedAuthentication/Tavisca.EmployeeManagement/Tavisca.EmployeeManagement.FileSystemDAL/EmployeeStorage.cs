        ...
        public Model.Employee Save(Model.Employee employee)
        {
            try
            {
                ...
                SqlConnection con = new SqlConnection("Data Source=TRAINING12;Initial Catalog=Employee;User ID=sa;Password=test123!@#");
                    ...
                    SqlParameter title = new SqlParameter("title", employee.Title);
                    SqlParameter email = new SqlParameter("Email", employee.Email);
                    SqlParameter phone= new SqlParameter("phno", employee.Phone);
                    SqlParameter doj = new SqlParameter("Doj", employee.JoiningDate.ToString());
                    SqlParameter password = new SqlParameter("Password","test123!@#");
